    ...
    def _setup_menu(self):
        ...
        if self._artist:
            ...
            for index, album_folder in enumerate(artist_folder.iterdir()):
                ...
                self.menu.add_item(album_folder.name, partial(self._request_screen, "songs", { "return_index": index, "return_screen": "artist", "album": album_folder.name, "artist": self._artist, "from_artist": True, "from": self._return_screen }))
        else:
            index = 0
